...
test("returns null (never throws) for invalid gross cash inputs", () => {
  assert.equal(estimateSpainPayroll2026(0), null);
  assert.equal(estimateSpainPayroll2026(-1), null);
  assert.equal(estimateSpainPayroll2026(Number.NaN), null);
  assert.equal(estimateSpainPayroll2026(Number.POSITIVE_INFINITY), null);
});
